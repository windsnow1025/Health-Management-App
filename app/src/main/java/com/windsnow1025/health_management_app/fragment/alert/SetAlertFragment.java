    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tableAdapter1 = new TableAdapter(data, pos -> {
            ...
            builder.setNegativeButton("吃药提醒", (dialog, which) -> {
                ...
                transaction.replace(R.id.fragment_container, new MedicineFragment(true, i, true, adapter));
            ...
            builder.setPositiveButton("复诊提醒", (dialog, which) -> {
                FragmentTransaction transaction = getParentFragmentManager().beginTransaction();
                int i = Integer.parseInt(data.get(pos)[3]);
                transaction.replace(R.id.fragment_container, new DiagnoseFragment(false, i, true, adapter));
                transaction.addToBackStack(null);
                transaction.commit();
            });
            builder.show();
        ...
        tableAdapter2 = new TableAdapter(data1, pos -> {
            ...
            builder.setNegativeButton("吃药提醒", (dialog, which) -> {
                ...
                transaction.replace(R.id.fragment_container, new MedicineFragment(true, i, false, adapter));
                transaction.addToBackStack(null);
                transaction.commit();
            });
            builder.setPositiveButton("复诊提醒", (dialog, which) -> {
                FragmentTransaction transaction = getParentFragmentManager().beginTransaction();
                int i = Integer.parseInt(data1.get(pos)[3]);
                transaction.replace(R.id.fragment_container, new DiagnoseFragment(false, i, false, adapter));
                transaction.addToBackStack(null);
                transaction.commit();
            });
            builder.show();
