...
public class UpdateUsernameApi extends AsyncTask<String, Void, String> {
    ...
    private static final String API_URL_UPDATE_USERNAME = "https://www.windsnow1025.com/learn/api/android/user/username";
    ...
    protected String doInBackground(String... params) {
        ...
        // 先调用登录API获取用户信息
        String apiResult = callApi(phoneNumber, username);
        return apiResult;
    }

    private String callApi(String phoneNumber, String username) {
    ...
    // 用于检查用户密码并返回手机号
    public String updateUsername(String phoneNumber, String username) {
        // 调用异步任务的 execute 方法
