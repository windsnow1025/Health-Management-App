...
public class TableEnterAdapter extends RecyclerView.Adapter<TableEnterAdapter.ViewHolder> {

    private List<String[]> data;
    private OnItemClickListener editButtonClickListener;
    private OnItemClickListener deleteButtonClickListener;

    public TableEnterAdapter(List<String[]> data, OnItemClickListener editButtonClickListener, OnItemClickListener deleteButtonClickListener) {
        this.data = data;
